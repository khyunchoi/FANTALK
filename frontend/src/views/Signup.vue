<template>
  <div>       
      <form class="signup">
        ...
        <div class="id_pw">
          <div class="right">
            <input id="id" v-model="credentials.id" class="card__input" placeholder="ID" type="text" />
          </div>
        </div>

        <div class="id_pw">
          <div class="right">
            <input id="name" v-model="credentials.name" class="card__input" placeholder="Name"  type="text" />
          </div>
        </div>

        <div class="id_pw">
          <div class="right">
            <input id="email" v-model="credentials.email" class="card__input" placeholder="email"  type="email" />
          </div>
        </div>
